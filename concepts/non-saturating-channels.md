...
## Session 45 — Density-dependent boundary gain: the two-wire principle's 13th member

The density-gain sweep tested whether the boundary gain g should scale with density. At n=175 (H7=4/4, coexist=1/4 at g=0.30 — over-fragmentation), lowering g rescues composition: g=0.15 → 4/4 coexist, g=0.20 → 4/4 coexist (2/4 full), g=0.25 → 2/4 coexist. At n=150 (coexist=4/4 at g=0.30), raising g destroys composition: g=0.35 → 0/4, g=0.40 → 1/4. The optimal gain is density-dependent: g*≈0.30 at n=150 (5.9/kc), g*≈0.20 at n=175 (6.8/kc).
...
### Session 56 (2026-09-11) — Over-recovery was a growth artifact; the damage signal amplifies
...
## Session 66 — The N550 Plateau: 1/√n Scaling Holds at ~31% Fill

The n=550–600 plateau sweep (72 runs) tested whether the 1/√n (Laplace pressure) scaling law (confirmed from n=170 to n=500, Sessions 46–54) holds at the highest density tested — ~31% grid fill — or whether g* finally hits zero (the LSW "droplet dissolves" prediction from finite-size scaling theory).

**g* does NOT hit zero.** Composition is alive at every gain tested (0.003–0.01) at both n=550 and n=600. H7=4/4 at all 6 combos. The LSW prediction is not realized even at ~31% fill — far below the 2D site percolation threshold (~59%). The 43rd mechanism: the 1/√n scaling is **conservative** — the Laplace pressure prediction g*(550)≈0.005 underestimates the optimal gain. n=550 g=0.01 (2× the predicted value) achieves 4/4 full co-occurrence (cf=0.712) — the best result at this density. The boundary can tolerate more suppression than the pressure analogy predicts.

**The 1-seed structural guarantee is stochastic, not monotonic.** The guarantee was 0/4 at n=500 (perfect, Session 54) but 2/4 at n=550–600. It does not strengthen monotonically with density — the 12th member (structure-to-grid ratio) produces a stochastic leak rate. The bigger single structure at n=550–600 does not necessarily leak more; the focal bias + curvature channel concentrate it effectively at some seeds but not others.
