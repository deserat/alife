...
**Status:** Refined (Session 64). At 32 seeds, the persistence condition holds robustly (27–28/32 stable, H7=32/32). The +0.062 L/R gap from 16 seeds shrinks >50% to +0.024 — mostly statistical. The 41st mechanism: the L/R asymmetry is a finite-size effect that shrinks with N. 50/90 has the strongest 1-seed guarantee (1/32). The 39th mechanism (asymmetric perturbation advantage) weakens — 50/50 has more full (27/32) than 50/90 (22/32).
...
**Status:** Refined ×54. The 32-seed robustness sweep (256 runs) found H7=32/32 at all configs — the crossing is fully robust to sample size (confirmed at 4, 8, 16, and 32 seeds). The +0.062 L/R gap from 16 seeds shrinks >50% to +0.024 — mostly statistical. The 41st mechanism: the L/R asymmetry is a finite-size effect that shrinks with N. 50/90 has the strongest 1-seed structural guarantee (1/32 vs 3/32 for 50/50 and 6/32 for 90/50). 50/50 has the most full (27/32) — the 39th mechanism (asymmetric perturbation advantage) weakens at 32 seeds. The 40th: sample-size-dependent asymmetry flip. The 38th: processing order as hidden symmetry-breaking. The 37th: bilateral perturbation composition-enhancing. The saturating-cue control (Session 57) confirms damage-amplified composition is unique to the non-saturating curvature channel. The crossing = boundary maintenance, not volume regrowth. Barman et al. (2026) confirms.
...
**Status:** Refined (Session 64). 41 mechanisms tested. The 32-seed sweep found the +0.062 L/R gap shrinks >50% to +0.024 — mostly statistical (41st mechanism: finite-size effect). H7=32/32 at all configs. 50/50 has the most full (27/32) — the 39th mechanism (asymmetric perturbation advantage) weakens at 32 seeds. 50/90 has the strongest 1-seed guarantee (1/32) and the highest cf (0.769).
...
|| H5: Autopoiesis | Refined (S64) | 32-seed: 27–28/32 stable, H7=32/32; +0.062 gap shrinks >50% to +0.024 (41st: finite-size effect); 50/90 strongest 1-seed guarantee (1/32); 50/50 has most full (27/32) | [H5](logs/H5/) |
...
| H7: Trace→Actor Crossing | Refined ×54; 32-seed: H7=32/32 all configs (fully robust at 4/8/16/32); +0.062 gap shrinks >50% to +0.024 (41st: finite-size effect); 50/50 has most full (27/32); 50/90 strongest 1-seed guarantee (1/32); crossing = boundary maintenance; Barman et al. (2026) confirms | Session 64 32-seed; Session 63 16-seed; Session 62 shuffle-iteration; Session 61 reverse-iteration; Session 60 8-seed robustness; Session 59 asymmetric bilateral; Session 58 bilateral; Session 57 saturating-cue control; Session 56 timing+size; Session 55 perturbation; Session 54 ultra-high-density; Session 53 high-density; Session 52 plateau 260–300; Session 51 plateau 240–250; Session 50 classifier-artifact; Session 49 robustness+asymmetric; Session 48 plateau; Session 47 robustness+n=200; Session 46 gain-scaling; Session 45 density-gain; Session 44 per-criteria; Session 43 threshold; Session 42 finer density; Session 34 movement; Session 33 dual; Session 22: 2×2 complete | [H7](logs/H7/) |
...
| H10: Unbounded Space Insufficiency | Refined (S64) | 32-seed: H7=32/32 all configs; +0.062 gap shrinks >50% to +0.024 (41st: finite-size effect); 50/50 has most full (27/32); 50/90 strongest 1-seed guarantee (1/32) and highest cf (0.769); 41 mechanisms; Barman et al. (2026) confirms | [H10](logs/H10/) |
