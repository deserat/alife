...
**Status:** Refined (Session 58). The 33rd mechanism is channel-specific — damage-amplified composition requires the non-saturating curvature channel's geometric signal. The saturating cue shows the opposite (H7=0/8, composition degrades with damage). Autopoiesis as boundary maintenance depends on the non-saturating channel (H11), not just the density+boundary. Over-recovery was a growth artifact (recovery drops 1.06→0.88→0.76 with later timing), but the crossing's stability function persists (H7=8/8, coexist=8/8 at all timings). The 34th mechanism: saturating-cue self-dampening (the intensive signal's failure mode). The 35th mechanism: bilateral damage amplifies the boundary from both sides (cf=0.825, 4/4 stable at bilateral 50%) — the persistence condition is bilateral. The persistence condition is organizational identity maintenance, not material restoration.
...
**Status:** Refined (Session 58). The 35th mechanism: bilateral damage amplifies the boundary from both sides — two moderate bilateral scars (cf=0.825, 4/4 full) outperform one severe unilateral scar (cf=0.713). 34th mechanism: saturating-cue self-dampening; 33rd: damage-amplified composition (requires non-saturating channel); 32nd corrected: boundary maintenance; g*≠0 at n=450–500; n=350 g=0.01 7/8 full; 35 mechanisms; Barman et al. (2026) confirms.
...
|| H5: Autopoiesis | Refined (S58) | 35th mechanism: bilateral damage amplifies boundary (cf=0.825, 4/4 stable); 33rd channel-specific; 34th saturating-cue self-dampening | [H5](logs/H5/) |
...
| H10: Unbounded Space Insufficiency | Refined (S58) | 35th: bilateral damage amplifies boundary; 34th: saturating-cue self-dampening; 33rd: damage-amplified composition; 32nd corrected: boundary maintenance; g*≠0 at n=450–500; n=350 g=0.01 7/8 full; 35 mechanisms; Barman et al. (2026) confirms | [H10](logs/H10/) |
