...
**Status:** Refined (Session 62). Shuffling shrinks the L/R gap (+0.113 → -0.019) but does not fully eliminate it. 50/50 is NOT the best under shuffle (cf=0.719, the worst) — the asymmetric perturbation advantage survives randomization. H7=8/8 at all configs. The persistence condition is processing-order-dependent (Session 61) but the processing-order component is the primary driver, not the only one. The 38th mechanism: processing order as a hidden symmetry-breaking variable. The 37th: bilateral perturbation composition-enhancing at 8 seeds. The 36th: bilateral advantage requires symmetry. The 35th: bilateral damage amplifies boundary. The 33rd: damage-amplified composition (requires non-saturating channel). The persistence condition is organizational identity maintenance, not material restoration.
...
**Status:** Refined (Session 43). The two-wire principle's 12th member confirmed at 8 seeds (1-seed leak 4/8). The composition optimum (n=150) is separated from the H7 threshold (n≥175) — the crossing and composition are governed by different density regimes, a new expression of the structure-to-grid ratio trade-off.
...
**Status:** Refined ×52. The shuffle-iteration sweep (Session 62) found the L/R gap shrinks dramatically under shuffled iteration (+0.113 → -0.019) but does NOT fully vanish. 50/50 is NOT the best under shuffle (cf=0.719, the worst) — Session 59's 4-seed prediction was a small-sample effect. The asymmetric perturbation advantage survives randomization. Shuffled 90/50 achieves 8/8 full (the best ever at an asymmetric config). H7=8/8 at all configs in both directions — the crossing is fully robust to iteration order. The reverse-iteration sweep (Session 61) found the L/R asymmetry is a pure processing-order artifact — reversing the iteration order flips the optimum from 50/90 to 90/50 (forward gap=+0.113, reverse gap=-0.025). The 38th mechanism: processing order as a hidden symmetry-breaking variable. The 37th: bilateral perturbation is composition-enhancing at 8 seeds (baseline 6/8 → perturbed 7/8). The asymmetric bilateral sweep (Session 59) found symmetric 50/50 remains best at 4 seeds (cf=0.825, 4/4 full); asymmetric degrades (50/90→3/4, 90/50→3/4). The 36th mechanism: bilateral advantage requires symmetry. The bilateral perturbation sweep (Session 58) found bilateral 50% produces the highest composition quality ever (cf=0.825, 4/4 full). The saturating-cue control (Session 57) confirms damage-amplified composition is unique to the non-saturating curvature channel (H7=8/8, composition improves with damage) — the saturating cue shows the opposite (H7=0/8, composition degrades with damage, cf drops 0.331→0.013). The 33rd mechanism requires the geometric (extensive) signal; the saturating cue's chemical (intensive) signal is self-dampening. Barman et al. (2026, ACS Nano) independently confirms geometry as an instructive damage signal. Over-recovery was a growth artifact (recovery drops 1.06→0.88→0.76 with later perturbation timing), but the crossing's stability function persists (H7=8/8, coexist=8/8 at all timings). The damage signal amplifies rather than saturates (75%/90% damage → 8/8 full). The crossing is boundary maintenance under damage, not volume regrowth. g* never hits zero at n=450–500 (~29% fill) — the 1/√n scaling holds. n=350 g=0.01 is the most robust config ever (7/8 full at 8 seeds).
...
**Status:** Refined (Session 62). Shuffling shrinks the L/R gap (+0.113 → -0.019) but does not fully eliminate it. 50/50 is NOT the best under shuffle (cf=0.719, the worst) — the asymmetric perturbation advantage survives randomization. Shuffled 90/50 achieves 8/8 full (best ever at an asymmetric config). 38th: processing order as hidden symmetry-breaking; 37th: bilateral perturbation composition-enhancing at 8 seeds; 36th: bilateral advantage requires symmetry; 35th: bilateral damage amplifies; 34th: saturating-cue self-dampening; 33rd: damage-amplified composition; 32nd: boundary maintenance; g*≠0 at n=450–500; n=350 g=0.01 7/8 full; 38 mechanisms; Barman et al. (2026) confirms.
...
|| H5: Autopoiesis | Refined (S62) | Shuffling shrinks L/R gap (+0.113 → -0.019) but does not eliminate it; 50/50 NOT best under shuffle; asymmetric advantage survives randomization; H7=8/8 all configs; 38th: processing order as hidden symmetry-breaking; 37th: bilateral perturbation composition-enhancing; 33rd: damage-amplified composition | [H5](logs/H5/) |
...
| H7: Trace→Actor Crossing | Refined ×52; shuffle shrinks L/R gap (+0.113 → -0.019) but does not eliminate it; 50/50 NOT best under shuffle (cf=0.719, worst); asymmetric advantage survives randomization; shuffled 90/50 8/8 full; H7=8/8 all configs both directions; 38th: processing order as hidden symmetry-breaking; saturating-cue control confirms 33rd unique to non-saturating channel; crossing = boundary maintenance; Barman et al. (2026) confirms | Session 62 shuffle-iteration; Session 61 reverse-iteration; Session 60 8-seed robustness; Session 59 asymmetric bilateral; Session 58 bilateral; Session 57 saturating-cue control; Session 56 timing+size; Session 55 perturbation; Session 54 ultra-high-density; Session 53 high-density; Session 52 plateau 260–300; Session 51 plateau 240–250; Session 50 classifier-artifact; Session 49 robustness+asymmetric; Session 48 plateau; Session 47 robustness+n=200; Session 46 gain-scaling; Session 45 density-gain; Session 44 per-criteria; Session 43 threshold; Session 42 finer density; Session 34 movement; Session 33 dual; Session 22: 2×2 complete | [H7](logs/H7/) |
...
| H10: Unbounded Space Insufficiency | Refined (S62) | Shuffling shrinks L/R gap (+0.113 → -0.019); 50/50 NOT best under shuffle (cf=0.719, worst); asymmetric advantage survives randomization; shuffled 90/50 8/8 full; 38th: processing order as hidden symmetry-breaking; 37th: bilateral perturbation composition-enhancing; 36th: bilateral advantage requires symmetry; 35th: bilateral damage amplifies; 34th: saturating-cue self-dampening; 33rd: damage-amplified composition; 32nd: boundary maintenance; g*≠0 at n=450–500; n=350 g=0.01 7/8 full; 38 mechanisms; Barman et al. (2026) confirms | [H10](logs/H10/) |
