...
**Status:** Refined (Session 30). sim12's autopoietic boundary (with memory) is more stable (4/4 vs 1/4 for the passive) and survives a 50% perturbation — supporting H5's claim that self-maintenance (memory) produces persistence. sim14's ID-tagged agents break the false-positive mechanism (1-seed 0/4, B_max=0.0) — the first structurally clean composition. The inh_gain sweep (Session 30) shows the strength-vs-growth trade-off is partially breakable: at g=0.5, H7=4/4 and L2=4/4 co-occur with 2/4 clean composition. But stable composition (2/4 at g=0.9) requires the strong boundary that kills H7 (0/4). The 1-seed control is 0/4 at ALL gains — the structural specificity guarantee holds across the entire strength spectrum. The tension is between crossing and *stable* composition, not crossing and composition per se. Autopoiesis is necessary for persistence, but the strength tuning that produces stability suppresses the crossing.
...
**Status:** Refined (Session 30). sim14's ID-tagged agents provide the agent-level specificity H6 requires — 1-seed control is 0/4 on all metrics (B_max=0.0). The two-wire requirement (persistence + specificity) is met: B has memory (persistence) and ID-based co-presence (specificity). The inh_gain sweep shows the two wires can partially decouple at intermediate gains (g=0.5: H7=4/4, L2=4/4, clean=2/4). The specificity wire holds at all gains (1-seed 0/4 from g=0.1 to g=0.9). But the co-occurrence is seed-dependent and rarely stable — at g=0.3 only 1/4 seeds achieve both stable composition and H7. The wires need structural decoupling, not just parameter tuning: a boundary whose strength is independent of the co-presence signal's precision (queued-topic #92).
...
**Status:** Refined ×19. The 2×2 is complete (Session 22), the φ_sat predictor was falsified (Session 23), the spatially-targeted recovery metric shows no targeted scar repair (Session 24), the crossing does not compose (Session 25), the long-range inhibitor is a weak positive (Session 26), the autopoietic boundary is more stable but less specific (Session 27), direct-material co-presence eliminates the torus leak but does not break the trade-off (Session 28), ID-tagged agents break the false-positive mechanism but suppress the crossing (Session 29), and **the inh_gain sweep finds the strength-vs-growth trade-off is partially breakable** (Session 30). At g=0.5, H7=4/4 and L2=4/4 co-occur with 2/4 clean composition — the first co-occurrence of crossing and composition. At g=0.3, one seed achieves stable composition WITH H7 crossing. But stable composition (2/4 at g=0.9) comes at the cost of H7 suppression (0/4). The 1-seed control is 0/4 at ALL gains — the structural specificity guarantee holds across the entire strength spectrum. **The tension is between crossing and *stable* composition, not crossing and composition per se. The trade-off is parameter-dependent, not fundamental, but is not robust (seed-dependent, rarely stable).**
...
**Status:** Strengthened (Session 30). sim14's ID-tagged agents achieve the first structurally clean composition — 1-seed control is 0/4 on all metrics (B_max=0.0). The inh_gain sweep shows the strength-vs-growth trade-off is partially breakable: at g=0.5, H7=4/4 and L2=4/4 co-occur with 2/4 clean composition. But stable composition (2/4 at g=0.9) comes at the cost of H7 suppression (0/4). The 1-seed control is 0/4 at ALL gains. The composition problem persists across eight independent mechanisms: chemical (sim05), saturating stigmergic (sim06/sim07), non-saturating density cap (sim08), non-saturating curvature (sim10), passive lateral inhibition (sim11), autopoietic lateral inhibition (sim12), direct-material autopoietic boundary (sim13), and ID-tagged heterogeneous agents (sim14). **The trade-off is between crossing and *stable* composition, not crossing and composition per se. The missing ingredient is a mechanism that decouples boundary strength from growth suppression, not just from specificity.**
...
| H5: Autopoiesis | Refined (S30) | sim12: memory improves persistence (4/4 vs 1/4); sim14: ID tagging breaks false positives (0/4) but suppresses H7 (0/4); inh_gain sweep: at g=0.5 H7=4/4+L2=4/4 co-occur but 0/4 stable; stable needs strong boundary that kills H7 | [H5](logs/H5/) |
| H6: Multi-Scale Autopoiesis | Refined (S30) | sim14: ID tagging provides specificity (1-seed 0/4, B=0); inh_gain sweep: two wires partially decouple at g=0.5 (H7=4/4, L2=4/4, clean=2/4); specificity holds at all gains; co-occurrence seed-dependent | [H6](logs/H6/) |
| H7: Trace→Actor Crossing | Refined ×19; inh_gain sweep: trade-off partially breakable — at g=0.5 H7=4/4 and L2=4/4 co-occur (2/4 clean); stable composition needs strong boundary that kills H7; 1-seed 0/4 at ALL gains; tension is crossing vs stable composition | Session 30 inh_gain sweep: g=0.5 H7=4/4+L2=4/4+clean=2/4; g=0.3 seed 999 stable+H7; g=0.9 stable 2/4 but H7 0/4; 1-seed 0/4 across all gains | [H7](logs/H7/) |
...
| H10: Unbounded Space Insufficiency | Strengthened (Session 30) | sim14 ID-tagged: first structurally clean composition (1-seed 0/4, B=0); inh_gain sweep: at g=0.5 H7=4/4+L2=4/4 co-occur; stable needs strong boundary that kills H7; trade-off is crossing vs stable composition; missing ingredient is decoupling strength from growth suppression | [H10](logs/H10/) |
