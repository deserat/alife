...
**Status:** Refined ×11. **The 2×2 is complete (Session 22). The non-saturating property reverses sign across families: it amplifies stability in the action family (sim09) but destroys it in the cue family (sim06 without self-maintenance).** Session 21 disentangled H11's confound (action-based vs non-saturating) via a saturating-action control: action-based routing is primary; non-saturating is a secondary stability amplifier in the action family. Session 22 completed the 2×2 with a cue-based non-saturating control (sim06 with `p = base + gain·φ` instead of `φ/(1+φ)`): the non-saturating cue crosses 0/16 stable without self-maintenance vs 16/16 for the saturating cue — the opposite of the action family and opposite to H11's strict prediction. The linear cue clamps to p=1.0 at φ≈1.15, flattening the gradient; mean pheromone drops to 0.467 < the 0.5 threshold. Self-maintenance rescues the linear cue (4/4 stable). The "self-defeating" channel is the non-saturating cue (deposit-probability clamping), not the saturating cue.
...
**Status:** Directionally confirmed (4/4), causally supported with a control arm, mechanism-decomposed, confound-resolved, and now 2×2-complete (Session 22). The corrected detector fires the crossing in the curvature channel and not in the baseline-pheromone control (same detector, 0/3) — H11's channel distinction is the causal variable separating crossing from non-crossing. Session 20's 2×2 factorial isolated the halves: recruit = necessary + almost-sufficient; limit = stability amplifier. Session 21's saturating-action control resolved the action-based vs non-saturating confound: action-based routing is primary; non-saturating is a secondary stability amplifier **in the action family**. Session 22's cue-based non-saturating control completed the 2×2 and found the non-saturating property **reverses sign** across families: in the cue family, the non-saturating cue crosses 0/16 stable without self-maintenance vs 16/16 for the saturating cue. The linear cue `p = base + gain·φ` clamps to p=1.0 at φ≈1.15, flattening the gradient (mean pheromone drops to 0.467 < 0.5 threshold); the saturating cue's `φ/(1+φ)` compression prevents deposit-probability saturation and preserves spatial contrast. Self-maintenance rescues the linear cue (4/4 stable). **H11's "self-defeating saturating channel" framing is backwards for the cue family — the self-defeating channel is the non-saturating cue (deposit-probability clamping), not the saturating cue.** The saturation that matters is deposit-probability clamping, not cue-response compression.
...
| H7: Trace→Actor Crossing | Refined ×11; 2×2 complete; non-saturating reverses sign across families | Session 22 cue-based control: non-saturating cue 0/16 stable w/o SM vs saturating 16/16; linear clamps p=1.0 at φ≈1.15, flattening gradient (phero 0.467 < 0.5); SM rescues 4/4 | [H7](logs/H7/) |
...
| H11: Saturating Channel | Directionally confirmed (4/4); causal with control arm; 2×2-complete; non-saturating reverses sign across families | Session 22 cue control: non-saturating cue 0/16 stable w/o SM vs saturating 16/16; "self-defeating" is backwards for cue family — self-defeating channel is the non-saturating cue (p-clamping), not the saturating cue | [H11](logs/H11/) |
