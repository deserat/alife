...
**Status:** Refined (Session 47). The 8-seed robustness confirms n=170 g=0.24 is a genuine optimum (3/8 full, not a 4-seed artifact). The n=200 sweep resolves the linear vs 1/√n question: the 1/√n (Laplace pressure) fit is the better predictor (g*(200)≈0.12 vs linear's 0.10). n=200 g=0.14 achieves 3/4 full with 4/4 coexist and 4/4 clean. The 1-seed leak persists (1/8 at n=170 8 seeds, 1/4 at n=200) — the 12th and 13th members remain independent problems.
...
**Status:** Refined ×36. H7 is 4/4 at all n≥155 across most gains — the crossing is density-robust and gain-independent within the crossing regime. 8-seed robustness at n=170 g=0.24 confirms 3/8 full (not a 4-seed artifact). The n=200 sweep confirms the 1/√n (Laplace pressure) scaling: g*(200)≈0.12, matching the 1/√n prediction. n=200 g=0.14 achieves 3/4 full with 4/4 coexist and 4/4 clean. The crossing threshold (~6/kc) is well below the composition optimum.
...
| H5: Autopoiesis | Refined (S47) | 8-seed robustness confirms 3/8 full; 1/√n scaling confirmed at n=200; 1-seed leak 1/8 at n=170, 1/4 at n=200 | [H5](logs/H5/) |
...
| H7: Trace→Actor Crossing | Refined ×36; 8-seed robustness 3/8 full; 1/√n (Laplace) scaling confirmed at n=200; n=200 g=0.14 achieves 3/4 full | Session 47 robustness+n=200; Session 46 gain-scaling; Session 45 density-gain; Session 44 per-criteria; Session 43 threshold; Session 42 finer density; Session 34 movement; Session 33 dual; Session 22: 2×2 complete | [H7](logs/H7/) |
...
| H10: Unbounded Space Insufficiency | Refined (S47) | 24th mechanism: n=200 plateau; 1/√n (Laplace) scaling confirmed g*(200)≈0.12; n=200 g=0.14 achieves 4/4 coexist + 4/4 clean | [H10](logs/H10/) |
