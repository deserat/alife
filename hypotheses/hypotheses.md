...
**Status:** Refined (Session 65). At 32 seeds, the persistence condition holds robustly (27–28/32 stable, H7=32/32). Bilateral damage rescues high-density stability (n=500: stable 2/4→4/4). At n=150 the persistence condition fails regardless (0/4 stable in both). The 42nd mechanism: bilateral damage rescues high-density composition and stability.
...
**Status:** Refined ×55. The 32-seed robustness sweep (256 runs) found H7=32/32 at all configs — the crossing is fully robust to sample size (confirmed at 4, 8, 16, and 32 seeds). The bilateral density sweep (Session 65, 72 runs) found the bilateral advantage is density-dependent: weak at n=150 (+0.025), confirmed at n=350 (+0.075), strongest at n=500 (+0.187, 2/4→4/4 full). The 42nd mechanism: bilateral damage rescues high-density composition by sharpening the boundary from both sides. H7=4/4 at n=350 and n=500. The advantage scales with structure size. The saturating-cue control (Session 57) confirms damage-amplified composition is unique to the non-saturating curvature channel. The crossing = boundary maintenance, not volume regrowth. Barman et al. (2026) confirms.
...
**Status:** Refined (Session 65). 42 mechanisms tested. The bilateral density sweep found the composition advantage is density-dependent: n=150 +0.025 (weak), n=350 +0.075 (confirmed), n=500 +0.187 (strongest, 2/4→4/4 full). The 42nd mechanism: bilateral damage rescues high-density composition. The advantage scales with structure size — it requires a minimum structure size to create sufficient curvature contrast. H7=32/32 at all configs (32-seed). H7=4/4 at n=350 and n=500.
...
|| H5: Autopoiesis | Refined (S65) | 32-seed: 27–28/32 stable, H7=32/32; bilateral damage rescues high-density stability (n=500: 2/4→4/4 stable); 42nd: bilateral rescues high-density composition+stability | [H5](logs/H5/) |
...
| H7: Trace→Actor Crossing | Refined ×55; 32-seed: H7=32/32 all configs (fully robust); bilateral density: advantage density-dependent (n=150 +0.025, n=350 +0.075, n=500 +0.187 2/4→4/4 full); 42nd: bilateral rescues high-density composition; crossing = boundary maintenance; Barman et al. (2026) confirms | Session 65 bilateral density; Session 64 32-seed; Session 63 16-seed; Session 62 shuffle-iteration; Session 61 reverse-iteration; Session 60 8-seed robustness; Session 59 asymmetric bilateral; Session 58 bilateral; Session 57 saturating-cue control; Session 56 timing+size; Session 55 perturbation; Session 54 ultra-high-density; Session 53 high-density; Session 52 plateau 260–300; Session 51 plateau 240–250; Session 50 classifier-artifact; Session 49 robustness+asymmetric; Session 48 plateau; Session 47 robustness+n=200; Session 46 gain-scaling; Session 45 density-gain; Session 44 per-criteria; Session 43 threshold; Session 42 finer density; Session 34 movement; Session 33 dual; Session 22: 2×2 complete | [H7](logs/H7/) |
...
| H10: Unbounded Space Insufficiency | Refined (S65) | 32-seed: H7=32/32 all configs; bilateral density: advantage density-dependent (n=500 +0.187, 2/4→4/4 full); 42nd: bilateral rescues high-density composition; 42 mechanisms; Barman et al. (2026) confirms | [H10](logs/H10/) |
